...
import com.ulaiber.ubossmerchant.activity.AlbumActivity;
import com.ulaiber.ubossmerchant.util.BitmapCache;
import com.ulaiber.ubossmerchant.util.BitmapCache.ImageCallback;
...
public class AlbumGridViewAdapter extends BaseAdapter {
	...
	public AlbumGridViewAdapter(Context c, ArrayList<ImageItem> dataList,
		...
		if(dataList == null) Log.i("cyan","datalist is null");
...
//	public AlbumGridViewAdapter(AlbumActivity c, ArrayList<ImageItem> dataList, ArrayList<ImageItem> tempSelectBitmap) {
//	}

	public int getCount() {
		if(dataList ==null){
			Log.i("adapter","dataList null");
		}
