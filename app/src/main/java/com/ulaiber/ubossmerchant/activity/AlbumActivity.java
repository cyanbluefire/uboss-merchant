...
import com.ulaiber.ubossmerchant.adapter.AlbumGridViewAdapter;
import com.ulaiber.ubossmerchant.util.AlbumHelper;
import com.ulaiber.ubossmerchant.util.Bimp;
import com.ulaiber.ubossmerchant.util.ImageBucket;
...
public class AlbumActivity extends Activity {
	...
	private void init() {
		...
		if(dataList==null) Log.i("AlbumActivity", "dataList nul");
...
//		if(dataList ==null){
//			Log.i("AlbumActivity","init dataList null");
//		}else{
//			Log.i(TAG,"init datalist is not null");
